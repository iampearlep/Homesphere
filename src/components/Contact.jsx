...
const Contact = () => {
  return (
    <div className='flex flex-col-reverse md:flex-row container mx-auto mt-32'>
      <div data-aos="fade-right" data-aos-offset="280" data-aos-easing="ease-in-out" className='w-full flex flex-col justify-center items-center md:justify-start md:items-start md:w-5/12 md:ml-16 overflow-hidden'>
