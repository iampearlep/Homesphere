...
const CTA = () => {
  return (
    <div className=' flex justify-center items-center container mx-auto mt-32 md:w-10/12'>
      <div data-aos="zoom-out" data-aos-offset="320" data-aos-easing="ease-in-out" className=' cta flex flex-col w-11/12 px-8 py-10 md:w-11/12 md:px-32 md:py-12 items-center text-center rounded-2xl border-8 border-tertiary '>
