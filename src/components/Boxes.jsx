...
const Boxes = () => {
  return (
    <div className='container grid gap-4 grid-cols-2 w-10/12'>
        <div className='flex flex-col items-center justify-center rounded-md shadow-sm py-6 hover:shadow-xl hover:duration-500 hover:delay-200 hover:ease-in-out'>
